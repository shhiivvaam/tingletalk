            ...
            {isOpen && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-2 md:p-6">
                    ...
                    <motion.div
                        ...
                        className="relative w-full max-w-lg max-h-[95vh] md:max-h-[90vh] bg-slate-900 border border-white/10 rounded-[1.5rem] md:rounded-[2rem] shadow-2xl overflow-hidden flex flex-col"
                    >
                        {/* Header Decoration */}
                        <div className="absolute top-0 inset-x-0 h-1 md:h-1.5 bg-gradient-to-r from-pink-500 via-violet-600 to-cyan-500 shrink-0" />
                        ...
                        <div className="p-6 md:p-10 overflow-y-auto custom-scrollbar flex-1">
                            ...
                            <div className="flex flex-col sm:flex-row gap-3">
                                <button
                                    onClick={onAgree}
                                    className="flex-1 py-3.5 md:py-4 px-6 bg-gradient-to-r from-pink-500 to-violet-600 hover:from-pink-600 hover:to-violet-700 text-white font-black rounded-xl shadow-lg shadow-pink-500/20 active:scale-[0.98] transition-all uppercase tracking-widest text-xs md:text-sm"
                                >
                                    I Agree & Proceed
                                </button>
                                <button
                                    onClick={onDisagree}
                                    className="px-8 py-3.5 md:py-4 bg-white/5 hover:bg-white/10 text-slate-400 font-bold rounded-xl active:scale-[0.98] transition-all border border-white/5 text-xs md:text-sm"
                                >
                                    Disagree
                                </button>
                            </div>

                            <p className="text-center text-[9px] md:text-[10px] text-slate-600 mt-6 uppercase font-bold tracking-widest leading-relaxed">
